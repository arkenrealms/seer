...
- Added extra fail-fast precondition guards for ad-hoc helpers in `node/src/tests.ts` (`updateUserAchievements`, `monitorMarketEvents`) to reduce runtime maintenance footguns.
